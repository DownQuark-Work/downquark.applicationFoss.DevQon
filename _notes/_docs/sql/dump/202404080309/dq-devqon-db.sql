...
(21,'f07ddc36-f566-11ee-a619-c29d42d3cfc8','ACCNT_PERSONAL','0_UNCONFIRMED','ROLE','ACCOUNT','2024-04-08 05:14:56','2024-04-08 05:14:56','2024-04-08 03:06:13'),
...
(23,'f1bb5e20-f575-11ee-a619-c29d42d3cfc8','ACCNT_PERSONAL','0_UNCONFIRMED','ROLE','ACCOUNT','2024-04-08 07:02:21','2024-04-08 07:02:21','2024-04-08 03:05:18');
...
CALL `DownQuark`.AggregateUserLookup(NEW.id) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
(21,'4F9520CAF7A8F9B1A938CF36E5','325872A41D28CFAAE3FB5CF211CD9470'),
(22,'B8E3797AC1113561535E7BED4E','79868460957EF805A8CF2DAA15ABD4E1'),
(23,'5F44617E66B5319CDAEF3A1CC4','F88A3D90724233878F28B33E12FC0B27');
...
CREATE TABLE `accounts_organization` (
  ...
  PRIMARY KEY (`id`),
  KEY `accounts_organization_Location_FK` (`state`),
...
(1,'DownQuark','https://www.downquark.work','MA');
...
CREATE TABLE IF NOT EXISTS QrxAggregate.`dq_lookup_users` (
  ...
  SELECT fetch_lookup_user_id_encrypt;
...
('4D6A453D','f07ddc36-f566-11ee-a619-c29d42d3cfc8','0_UNCONFIRMED'),
('4D6A493D','af9287ee-f56b-11ee-a619-c29d42d3cfc8','0_UNCONFIRMED'),
('4D6A4D3D','f1bb5e20-f575-11ee-a619-c29d42d3cfc8','0_UNCONFIRMED');
...
-- Dump completed on 2024-04-08 23:14:31
