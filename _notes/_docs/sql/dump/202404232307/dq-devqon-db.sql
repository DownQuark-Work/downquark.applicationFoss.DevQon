...
IF ISNULL(proj_id) THEN -- allows TO append IF id IS passed AS argument
  DROP TABLE IF EXISTS `QrxAggregate`.`dq_projects_config_path`;
END IF;
-- CREATE TABLE `dq_projects_config_path` (
CREATE TABLE IF NOT EXISTS `QrxAggregate`.`dq_projects_config_path` (
  `project_id` uuid NOT NULL,
  `project_name` varchar(50) DEFAULT NULL,
  `config_file_path` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`project_id`),
  UNIQUE KEY `project_name` (`project_name`),
  CONSTRAINT `dq_projects_config_path__dq_projects_FK` FOREIGN KEY (`project_id`) REFERENCES `DownQuark`.`_dq_projects` (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `QrxAggregate`.`dq_projects_config_path` (project_id,project_name,config_file_path) VALUES (fetch_project_id,proj_name,file_path);
...
IF ISNULL(usr_id) THEN -- allows TO append IF id IS passed AS argument
  DROP TABLE IF EXISTS `QrxAggregate`.`dq_config_id_user_id`;
END IF;
CREATE TABLE IF NOT EXISTS QrxAggregate.`dq_config_id_user_id` (
  ...
  UNIQUE KEY `dq_lookup_users_unique` (`usr`)
    ...
    INSERT INTO `QrxAggregate`.`dq_config_id_user_id` (usr,usr_id,role) VALUES (fetch_lookup_user_id_encrypt,fetch_user_id,fetch_user_role);
...
--
-- Table structure for table `dq_projects_config_path`
--

DROP TABLE IF EXISTS `dq_projects_config_path`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dq_projects_config_path` (
  `project_id` uuid NOT NULL,
...
--
-- Dumping data for table `dq_projects_config_path`
--

LOCK TABLES `dq_projects_config_path` WRITE;
/*!40000 ALTER TABLE `dq_projects_config_path` DISABLE KEYS */;
INSERT INTO `dq_projects_config_path` VALUES
...
/*!40000 ALTER TABLE `dq_projects_config_path` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dq_config_id_user_id`
--

DROP TABLE IF EXISTS `dq_config_id_user_id`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dq_config_id_user_id` (
  `usr` varchar(15) NOT NULL COMMENT 'lookup key',
  `usr_id` uuid NOT NULL,
  `role` varchar(25) NOT NULL,
  PRIMARY KEY (`usr_id`),
...
--
-- Dumping data for table `dq_config_id_user_id`
--

LOCK TABLES `dq_config_id_user_id` WRITE;
/*!40000 ALTER TABLE `dq_config_id_user_id` DISABLE KEYS */;
INSERT INTO `dq_config_id_user_id` VALUES
...
/*!40000 ALTER TABLE `dq_config_id_user_id` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-04-23 23:07:42
