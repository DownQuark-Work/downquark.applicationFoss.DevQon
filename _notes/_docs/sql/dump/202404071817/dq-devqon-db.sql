...
DROP DATABASE IF EXISTS `DownQuark`;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER insert_project
  AFTER UPDATE ON `downquark`.`_dq_projects` FOR EACH ROW
  CALL`downquark`.CreatePaths('63823eca-f3e6-11ee-96c2-c29d42d3cfc8NULL') */;;
DELIMITER ;
...
(1,'63a03700-f18d-11ee-96c2-c29d42d3cfc8','ACCNT_INTERNAL','4_SUDO','ROLE','ACCOUNT','2024-04-03 07:40:05','2024-04-03 07:40:05'),
(3,'e9b17692-f18d-11ee-96c2-c29d42d3cfc8','ACCNT_PERSONAL','0_UNCONFIRMED','ROLE','ACCOUNT','2024-04-03 07:43:50','2024-04-03 07:43:50'),
(4,'0cf18318-f18e-11ee-96c2-c29d42d3cfc8','ACCNT_PERSONAL','1_CONFIRMED','ROLE','ACCOUNT','2024-04-03 07:44:50','2024-04-03 07:44:50'),
(5,'0cf1b158-f18e-11ee-96c2-c29d42d3cfc7','ACCNT_ORGANIZATION','2_ORG_LEADER','ROLE','ACCOUNT','2024-04-03 07:44:50','2024-04-03 07:44:50'),
(6,'0cf1c8d2-f18e-11ee-96c2-c29d42d3cfc8','ACCNT_DEVELOPMENT','x_BANNED','ROLE','ACCOUNT','2024-04-03 07:44:50','2024-04-03 07:44:50'),
(7,'0cf23fd8-f18e-11ee-96c2-c29d42d3cfc8','ACCNT_PERSONAL','2_MOD','ROLE','ACCOUNT','2024-04-03 07:44:50','2024-04-03 07:44:50'),
(8,'0cf1b158-f18e-11ee-96c2-c29d42d3cfc6','ACCNT_ORGANIZATION','1_ORG_EMPLOYEE','ROLE','ACCOUNT','2024-04-03 07:44:50','2024-04-03 07:44:50'),
(9,'0cf1b158-f18e-11ee-96c2-c29d42d3cfc8','ACCNT_ORGANIZATION','1_ORG_EMPLOYEE','ROLE','ACCOUNT','2024-04-03 07:44:50','2024-04-03 07:44:50'),
(10,'3cf23fd8-f18e-11ee-96c2-c29d42d3cfc8','ACCNT_INTERNAL','3_ADMIN','ROLE','ACCOUNT','2024-04-03 07:44:50','2024-04-03 07:44:50'),
(11,'df4b1258-f197-11ee-96c2-c29d42d3cfc8','ACCNT_PERSONAL','0_UNCONFIRMED','ROLE','ACCOUNT','2024-04-03 08:55:08','2024-04-03 08:55:08');
...
--
-- Table structure for table `qrx_aggregate_dq_project`
--

DROP TABLE IF EXISTS `qrx_aggregate_dq_project`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `qrx_aggregate_dq_project` (
  `pid` uuid NOT NULL,
...
--
-- Dumping data for table `qrx_aggregate_dq_project`
--

LOCK TABLES `qrx_aggregate_dq_project` WRITE;
/*!40000 ALTER TABLE `qrx_aggregate_dq_project` DISABLE KEYS */;
INSERT INTO `qrx_aggregate_dq_project` VALUES
...
/*!40000 ALTER TABLE `qrx_aggregate_dq_project` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Current Database: `DevQon`
--
DROP DATABASE IF EXISTS `DevQon`;
...
-- Dump completed on 2024-04-07 18:17:43
